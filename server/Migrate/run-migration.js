...
const migrationFile = sqlInMigrate(
  arg === 'separacao-confirmada'
    ...
    : arg === 'status-fases'
      ...
      : arg === 'requisicoes-finalizado-em' || arg === 'finalizado-em'
        ? 'migrate-requisicoes-finalizado-em.sql'
      : arg === 'requisicoes-entregue-em' || arg === 'entregue-em'
        ? 'migrate-requisicoes-entregue-em.sql'
      : arg === 'tra-gerada'
                ...
                : arg === 'usuarios-requisicoes-armazem-origem'
                  ...
                  : arg === 'itens-nao-cadastrados' || arg === 'itens-nao-cadastrados-columns'
                    ...
                    : arg === 'requisicoes-devolucao-docs' || arg === 'devolucao-docs'
                      ...
                      : arg === 'requisicoes-itens-drop-serialnumber-index' || arg === 'drop-serialnumber-index'
                        ? 'migrate-requisicoes-itens-drop-serialnumber-index.sql'
